  ...
  <div class="dashboard-layout">
    ...
    <main class="dashboard-main">
      <div class="app-shell-offset-min-height w-full bg-surface p-6">
        ...
        <?php elseif ($k8s_namespace !== '' && $k8s_deployments_error_code === null): ?>
        <div class="mt-6">
          <div class="rounded-lg border border-dashed px-4 py-6 text-sm text-muted-foreground">
            Aucun deployment trouvé dans le namespace <span class="font-mono"><?= htmlspecialchars($k8s_namespace, ENT_QUOTES, 'UTF-8') ?></span>.
          </div>
        </div>
        <?php elseif ($k8s_namespace === ''): ?>
        <div class="mt-6">
          <div class="rounded-lg border border-amber-200 bg-amber-50 dark:bg-amber-900/10 px-4 py-3 text-sm text-amber-700 dark:text-amber-400">
            Namespace Kubernetes non configuré sur ce compte. Contactez l'administrateur.
          </div>
        </div>
        <?php endif ?>
