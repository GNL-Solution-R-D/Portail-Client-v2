            ...
            <div data-slot="card" class="bg-background text-card-foreground flex flex-col gap-6 rounded-xl border py-3 shadow-sm">
              ...
              <div data-slot="card-content" class="px-6 grid grid-cols-1 gap-6 lg:grid-cols-4">
                <div class="col-span-1 flex flex-col gap-4">
                  <div data-slot="card" class="metric-card bg-background text-card-foreground flex flex-col gap-6 rounded-xl border border-l-4 border-l-green-500 shadow-sm">
                  ...
                  <div data-slot="card" class="metric-card bg-background text-card-foreground flex flex-col gap-6 rounded-xl border border-l-4 border-l-blue-500 shadow-sm">
                    <div data-slot="card-content" class="p-4">
                      <div class="flex items-center gap-3">
                  ...
                  <div data-slot="card" class="metric-card bg-background text-card-foreground flex flex-col gap-6 rounded-xl border border-l-4 border-l-purple-500 shadow-sm">
                    <div data-slot="card-content" class="p-4">
                      <div class="flex items-center gap-3">
