            ...
            <div class="px-6 pt-6">
              <div class="mb-4 border-b pb-4">
                <div data-state="closed" data-slot="collapsible">
                  <div data-state="closed" id="radix-«R4nneplb»" hidden="" data-slot="collapsible-content" class="mt-1 space-y-1"></div></div></div></div><div class="flex-1 px-6 pb-6"><small class="text-muted-foreground mb-3 block text-xs font-bold tracking-wide uppercase">Navigation</small>
