...
// Le champ 'account' dans la table 'domains' de PowerDNS doit correspondre à $_SESSION['user']['id'] ou à un autre identifiant pertinent
$user_account = $_SESSION['user']['id'];

// Récupérer les domaines depuis la base PowerDNS via le champ 'account'
...
// Message d'information si aucun domaine n'est configuré
if (!$domains) {
    $alert_type = "error";
    $alert_title = "Erreur";
    ...
    <aside class="sidebar">
      <nav>
        ...
        <main class="main-content">
            <?php
            // Si aucun domaine n'est lié, afficher le message d'information ou inclure alert-info.php
            if (!$domains) {
