...
// Si aucun domaine n'est configuré, on définit un message d'information
if (!$domains) {
    $info = "Aucun domaine configure pour votre compte.";
}
if ($domains) {
    $info = "Vous etes sur la plateforme Administrateur.";
}
...
?>
  <span class="stat-label">Ajouter un document</span>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        $stmt = $pdo->prepare("INSERT INTO users (siren, name, structure_type, college, cotisation_type, password) VALUES (?, ?, ?, ?, ?, ?)");
        $stmt->execute([$siren, $name, $structure_type, $college, $cotisation_type, $hashedPassword]);
...
?>
    ...
    <form method="POST">
        ...
        <select name="college" required>
            <option value="WEB">College web</option>
            <option value="CLOUD">College cloud</option>
            <option value="WEB-CLOUD">College web et cloud</option>
        </select>

        <select name="cotisation_type" required>
            <option value="Exonere">Exonere de cotisation</option>
            <option value="Mensuel">Cotisation mensuel</option>
            <option value="Trimestriel">Cotisation Trimestriel</option>
            <option value="Annuel">Cotisation Annuel</option>
        </select>
